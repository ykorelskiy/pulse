...
class LLMCurator:
    ...
    def curate_and_translate_news(
        ...
        try:
            ...
            prompt = (
                ...
                "   - **Дикие пограничные и автотрюки**: литовец на Audi протаранил КПП Нида, "
                "объехал «зубы дракона» и вернулся, проезды через закрытые границы.\n"
                "   - **Виральные праздники и курьёзы**: Международный день пива, маленький "
                "носорог прогнал 10 львов, политик случайно подключился к совещанию из ванной.\n"
                "   - **Мировые курьёзы и поп-культура**: Человек-паук у Белого дома, "
                "сушат шоссе вентиляторами в Индии, гигантские зеркала в космосе.\n"
                "   - **Важная российская оборонная и геополитическая повестка**: сводки МО РФ, "
                "юбилеи и успехи ПВО/зенитчиков, ключевые санкции.\n"
    ...
    def _fallback_curation(
        ...
        stop_words = [
            ...
            "собрали", "тонн овощей", "тепличных"
        ]

        # High priority viral, science, pop culture, wild stunts, and major defense keywords
        priority_words = [
            "нида", "протаранил", "зубы дракона", "день пива", "литов",
