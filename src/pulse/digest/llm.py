...
class LLMCurator:
    ...
    def curate_and_translate_news(
        ...
        try:
            ...
            prompt = (
                ...
                "Твоя задача — отобрать 10 САМЫХ ярких, виральных и понятных массовому "
                "читателю новостей дня для создания сатирического арт-плаката.\n\n"
                "СТРОГИЕ ПРАВИЛА ОТБОРА:\n"
                "1. **Категорический ЗАПРЕТ (ВЫРЕЗАТЬ из ТОП-10)**:\n"
                "   - Узкие анонсы видеоигр, трейлеры, скидки и релизы в Steam "
                "(Serious Sam, Breathedge и т.д.), КРОМЕ супергигантов уровня GTA VI.\n"
                "   - Глубокие железячные и программистские спецификации "
                "(SSD, cuFile, GPU-шины, прошивки, чипсеты).\n"
                "   - Потребительские дефекты автомобилей (Tesla Cybertruck) и мелкий ремонт.\n"
                "   - Сухую аграрную и производственную статистику («собрали 1 млн тонн овощей»).\n"
                "   - Мелкие сплетни шоу-бизнеса, некрологи, памятники, спортивную статистику.\n"
                "   - Законодательный канцелярит Сената США («одобрил пакет инициатив»).\n\n"
                "2. **ВЫСШИЙ ПРИОРИТЕТ ВИТРИНЫ (Искать и ставить на 1-5 места)**:\n"
                "   - **Дикие городские происшествия с животным миром**: пенсионерка в Москве "
                "держала в квартире каймана и редких животных, маленький носорог "
                "прогнал 10 львов.\n"
                "   - **Виральные праздники и народные даты**: Всемирный день пива, конец первой "
                "рабочей недели августа.\n"
                "   - **Экшн на границе**: литовец на Audi протаранил КПП Нида, "
                "объехал «зубы дракона» и вернулся обратно.\n"
                "   - **Понятные всем конфузы чиновников**: политик случайно подключился "
                "к совещанию из ванной комнаты.\n"
                "   - **Массовый ИИ и поп-культура**: модель OpenAI оказалась слишком умной, "
                "Человек-паук у Белого дома, задержка Ведьмака.\n\n"
                "3. **СТРОГАЯ ДЕДУПЛИКАЦИЯ**:\n"
                "   - Категорически ЗАПРЕЩЕНО включать 2 новости на одну и ту же тему! "
    ...
    def _fallback_curation(
        ...
        # Stop words to penalize gaming trailers, tech specs, petty gossip & agricultural stats
        stop_words = [
        ...
        priority_words = [
            "кайман", "пенсионерк", "день пива", "пива", "нида", "протаранил",
            "зубы дракона", "литов", "вентилятор", "человек-паук", "хиросим",
            "gta", "носорог", "зеркал", "ураган", "ведьмак", "anthropic",
            "мо рф", "сенат", "пончик", "кенгуру", "особняк", "зенитчик",
            "белый дом", "шоссе", "инди", "openai", "ванной"
        ]
